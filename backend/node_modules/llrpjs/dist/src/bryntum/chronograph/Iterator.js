...
exports.MI = exports.MemoizedIterator = exports.MemoizedIteratorClass = exports.CI = exports.ChainedIterator = exports.ChainedIteratorClass = exports.concatIterable = exports.concat = exports.takeUntilExcluding = exports.takeUntilIncluding = exports.takeWhile = exports.reverse = exports.uniqueOnlyBy = exports.uniqueOnly = exports.reduce = exports.map = exports.some = exports.every = exports.drop = exports.filter = exports.inBatchesBySize = exports.split = void 0;
//---------------------------------------------------------------------------------------------------------------------
/**
...
exports.inBatchesBySize = inBatchesBySize;
//---------------------------------------------------------------------------------------------------------------------
...
exports.uniqueOnlyBy = uniqueOnlyBy;
//---------------------------------------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------------------------------------
function* takeUntilIncluding(iterator, func) {
    let i = 0;
    for (const el of iterator) {
        yield el;
        if (func(el, i++))
...
exports.takeUntilIncluding = takeUntilIncluding;
//---------------------------------------------------------------------------------------------------------------------
function* takeUntilExcluding(iterator, func) {
    let i = 0;
    for (const el of iterator) {
        if (func(el, i++))
            return;
...
exports.takeUntilExcluding = takeUntilExcluding;
//---------------------------------------------------------------------------------------------------------------------
...
exports.MemoizedIteratorClass = MemoizedIteratorClass;
const MemoizedIterator = (iterator) => new MemoizedIteratorClass(iterator);
exports.MemoizedIterator = MemoizedIterator;
exports.MI = exports.MemoizedIterator;
